...
- verdict field: ALWAYS capitalize first letter (e.g. "Expensive but compounding" not "expensive but compounding")
...
- If RSI/MACD/SMA are N/A, say so in ONE sentence and move on — do not repeat it in every field
- methodology_notes: generate 2-4 SPECIFIC caveats for THIS ticker only

Return ONLY valid JSON — no markdown, no preamble:
{"verdict":"Capitalized 2-4 word verdict","verdict_sub":"1 sentence with 2+ numbers","verdict_color":"green|yellow|red|gray","verdict_icon":"bull|bear|neutral|watch","capital":"3-4 sentences: PE vs sector, FCF yield, ROIC vs WACC, margin trend — each with a number","cashflow":"2-3 sentences: FCF quality, margins, capital allocation — each with a number","technical":"2-3 sentences on RSI/SMA/MACD — if all N/A say so in 1 sentence only","analyst_view":"2-3 sentences: analyst count, consensus, target, upside — each with a number","solvency":"2-3 sentences: Altman Z zone, Piotroski tier, D/E, liquidity — each with a number","risks":"2-3 sentences: 2-3 specific risks with data points, 1 macro risk if relevant","credit_decision":"1-2 sentences: creditworthiness with specific ratios","retail_summary":{"what_they_do":"2-3 sentences, no jargon, main revenue source","price_story":"2-3 sentences plain language on price action and RSI/SMA if available","is_it_cheap":"2-3 sentences: PE vs history, FCF yield in dollars per $100 invested, verdict: undervalued/fairly priced/expensive","making_money":"2 sentences: net margin as keeps $X per $100 revenue","debt_plain":"2 sentences: debt as X years of earnings, whether sector makes it normal","main_risk_plain":"2-3 sentences: top 1-2 risks in plain language with data","analyst_take_plain":"2 sentences: buy vs sell count, target price, credible or optimistic","verdict_plain":"1 direct sentence with at least 1 number"},"methodology_notes":["Specific caveat 1 naming metric + limitation + implication","Specific caveat 2","Optionally 3-4"]}"""
