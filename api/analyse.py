...
- TARGET LENGTH: This is a full institutional research note — aim for 900-1400 words across all fields. Each section must be substantive. Write as if an analyst will spend 8-10 minutes reading this. Do NOT truncate any field.

Return ONLY valid JSON — no markdown, no preamble:
{"verdict":"Capitalized 2-4 word verdict with key number","verdict_sub":"1 sentence core thesis with 2+ specific numbers","verdict_color":"green|yellow|red|gray","verdict_icon":"bull|bear|neutral|watch","capital":"5-6 sentences: PE vs sector median AND historical average, FCF yield vs 2%/6% benchmarks, ROIC vs sector WACC with explicit value-creation or destruction statement, margin trend, valuation premium or discount justification — every sentence with a number","cashflow":"4-5 sentences: FCF absolute value and FCF yield, FCF vs net income divergence and signal, capital allocation priorities, cash conversion quality, working capital comment — numbers in every sentence","technical":"3-4 sentences: RSI with precise interpretation, SMA50 vs SMA200 with price levels, MACD momentum signal, overall technical bias. If N/A state in one sentence then continue with available data","analyst_view":"4-5 sentences: total analyst count and statistical weight, buy/hold/sell breakdown with percentages, consensus target and upside credibility, estimate revision direction, whether consensus leads or lags fundamentals","solvency":"4-5 sentences: Altman Z zone with default probability context, Piotroski F with pass/fail signal commentary, current ratio and quick ratio interpretation, D/E vs sector norm, refinancing risk assessment","risks":"4-5 sentences: one valuation risk, one operational/fundamental risk, one macro risk linked to VIX/rates/HY spread data — each anchored to a specific number","credit_decision":"3-4 sentences: FCF coverage of debt service, Z-Score context, macro credit environment impact, explicit recommendation with covenant suggestion if appropriate","retail_summary":{"what_they_do":"3-4 sentences, no jargon, what they do, how they make money, main revenue source","price_story":"3-4 sentences plain language on price action, RSI and SMA in plain terms, entry zone or falling knife — N/A if unavailable","is_it_cheap":"3-4 sentences: PE vs history and sector, FCF yield as dollars per $100 market value, direct verdict: undervalued/fairly priced/expensive","making_money":"3 sentences: net margin as keeps $X per $100 revenue, trend direction, quality comment","debt_plain":"3 sentences: debt as X years of earnings, sector context, lender perspective","main_risk_plain":"3-4 sentences: top 2 risks in plain language anchored to data, include 1 macro risk","analyst_take_plain":"3 sentences: buy vs sell count, target price, credible or sell-side optimism assessment","verdict_plain":"2 direct sentences with at least 1 number each. End with buy, hold, or avoid."},"methodology_notes":["Specific caveat 1: metric name + limitation + interpretation implication","Specific caveat 2: ...","Add 2-5 total, each specific to this ticker"]}"""
