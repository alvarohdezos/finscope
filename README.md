...
The weekly email pipeline runs on Make.com: every Monday it reads user watchlists from Supabase, calls the API for each ticker, and sends a personalised executive summary.
